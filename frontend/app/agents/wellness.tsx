    ...
    <View style={{ flex: 1, backgroundColor: Colors.background }}>
      <View style={[styles.header, { backgroundColor: Colors.navy }]}>
        ...
        <View style={{ alignItems: 'center' }}>
          <View style={[styles.iconWrap, { backgroundColor: Colors.lavender }]}>
            <Text style={{ fontSize: 28 }}>🧠</Text>
          </View>
          <Text style={styles.headerTitle}>WellnessGuide Agent</Text>
          <Text style={styles.headerSub}>Mental health & daily check-ins</Text>
        </View>
      </View>
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100 }}>
        <View style={[styles.card, { alignItems: 'center', paddingVertical: 40 }]}>
          ...
          <Text style={{ fontSize: 13, color: Colors.textMid, textAlign: 'center' }}>WellnessGuide is being built. Check back soon!</Text>
        </View>
      </ScrollView>
    </View>
  );
